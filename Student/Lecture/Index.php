            ...
            <div class="my-5">
                <div class="p-4">
                    <table class="table table-hover">
                        ...
                        <?php
                                $sql = "SELECT * FROM lecture_master WHERE Subject_Id = ".$SubjectId." AND Academic_Session_Id = ".$AcademicSessionId." ORDER BY `lecture_master`.`Staff_Id` ASC";
                                ...
                                while($row = mysqli_fetch_array($result))
                                {
                                    ...
                                    $sql1 = "SELECT * FROM staff_master WHERE Staff_Id = ".$StaffId;
                                    ...
                                    $sql2 = "SELECT * FROM Attendance_Master WHERE Lecture_Id = ".$LectureId." AND Student_Id = ".$StudentId;
                                    $result2 = $con->query($sql2);

                                    while($row2 = mysqli_fetch_array($result2))
                                    {
                                        $Attendance = $row2['Is_Present'];
                                    }
