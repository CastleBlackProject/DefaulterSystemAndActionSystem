        ...
        <form method="POST" action="">
            <div>
                ...
                <div class="form-group col-md-3">
                    <label></label>
                    <button type="button" id="btn_Search" class="btn btn-success">Add rows</button>
                </div> 
            </div>
            <hr/>
            <div class="form-row">
                <div class="form-group col-md-3 my-2">
                    <label for="select_FromPercent">From</label>
                    <input type="number" min="1" max="100" id="select_FromPercent" name="select_FromPercent" class="form-control"></input>
                </div>
                <div class="form-group col-md-3 my-2">
                    <label for="select_ToPercent">To</label>
                    <input type="number" min="1" max="100" id="select_ToPercent" name="select_ToPercent" class="form-control"></input>
                </div>
                <div class="form-group col-md-4 my-2">
                <label for="txt_defaulteraction">Defaulter Action</label>
                <textarea name="txt_defaulteraction" cols="50" rows="3"></textarea>
                </div>
            </div>
        </form>
    </div>            
